...
struct AppIcon {
    struct Login {
        ...
        static let eyeSlash = Image("eye-slash")
        static let loginRemembered = Image("login-rememberd")
        static let passwordEncrypt = Image("password-encrypt")
    ...
    struct Profile {
        ...
        static let profile = Image("icon-profile")
    }
    ...
    struct UpcomingRide {
        ...
        static let imagePlaceholder = Image("icon-ImagePlaceholder")
    }
