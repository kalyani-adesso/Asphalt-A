...
public struct AppStrings{
    ...
    enum userdefaultKeys: String {
        ...
        case deepLinkRideId = "com.adesso.rider.club.deepLinkRideId"
        case hasUnreadNotifications = "com.adesso.rider.club.notifications.hasUnread.v1"
    }
    ...
    enum JoinRide {
        ...
        static let byOrganizerPrefix = "By"
        ...
        static let yes = "Yes"
        static let no = "No"
        static let joinRideFailed = "Unable to join ride. Please try again."
        static let rideNotStartedTitle = "Ride Not Started"
        static let rideFutureMessage = "Your ride is in the future."
        static let ok = "OK"
    }
    ...
    enum ConnectedRide {
        ...
        static let navClose = "Close"
        static let navTitle = "Navigation"
        static let navCalculatingRoute = "Calculating route..."
        static let navUpdatingRoute = "Updating route..."
        static let navDirections = "Directions"
        static let navMapStandard = "Standard"
        static let navMapSatellite = "Satellite"
        static let navMapHybrid = "Hybrid"
        static let navDialogTitle = "Navigation"
        static let navOpenInApp = "In-App Navigation"
        static let navOpenAppleMaps = "Open in Apple Maps"
        static let navOpenGoogleMaps = "Open in Google Maps"
        static let navCancel = "Cancel"
        static let navDistanceKmFormat = "%.1f km"
        static let navDistanceMFormat = "%.0f m"
        static let navDurationHrMinFormat = "%d hr %d min"
        static let navDurationMinSuffix = "min"
        static let messageSentToPrefix = "Message sent to"
        static let newMessageFromPrefix = "New Message from"
        static let speedUnitKph = "kph"
        static let riderFallbackName = "Rider"
        ...
        static let rideSummaryTitle = "Ride Summary"
        static let organizerPrefix = "Organizer"
    }
