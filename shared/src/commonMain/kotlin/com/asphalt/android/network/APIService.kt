...
interface APIService {
    ...
    suspend fun postQuery(queryRequestDTO: QueryRequestDTO): APIResult<Unit>
    suspend fun postAnswer(queryId: String, answerRequestDTO: AnswerRequestDTO): APIResult<Unit>
}