...
sealed class RideStatType(val iconRes: Int, val bgColor: Color, val descriptionRes: Int) {
    object TotalRides :
        RideStatType(R.drawable.ic_path, PrimaryBrighterLightW60, R.string.total_rides)

    object Locations :
        RideStatType(R.drawable.ic_location, PrimaryBrighterLightW50, R.string.locations)

    object TotalKms : RideStatType(R.drawable.ic_navigate, BrightTeal, R.string.total_kms)
}