...
val dummyRideDataList = listOf(
    ...
    RidePerMonthDto(RideDateDto(2, 2024), PerMonthRideStatisticsDto(16, 15, 6200)),
    ...
    RidePerMonthDto(RideDateDto(6, 2024), PerMonthRideStatisticsDto(19, 14, 5400)),
    ...
    RidePerMonthDto(RideDateDto(9, 2024), PerMonthRideStatisticsDto(17, 11, 4300)),
    RidePerMonthDto(RideDateDto(10, 2024), PerMonthRideStatisticsDto(14, 21, 9000)),
    RidePerMonthDto(RideDateDto(11, 2024), PerMonthRideStatisticsDto(15, 29, 3700)),
    ...
    RidePerMonthDto(RideDateDto(2, 2025), PerMonthRideStatisticsDto(73, 25, 2000)),
    RidePerMonthDto(RideDateDto(3, 2025), PerMonthRideStatisticsDto(10, 15, 7900)),
    RidePerMonthDto(RideDateDto(4, 2025), PerMonthRideStatisticsDto(51, 22, 500)),
    RidePerMonthDto(RideDateDto(5, 2025), PerMonthRideStatisticsDto(28, 12, 680)),
    RidePerMonthDto(RideDateDto(6, 2025), PerMonthRideStatisticsDto(34, 28, 800)),
    RidePerMonthDto(RideDateDto(7, 2025), PerMonthRideStatisticsDto(42, 48, 160)),
    RidePerMonthDto(RideDateDto(8, 2025), PerMonthRideStatisticsDto(26, 42, 200)),
