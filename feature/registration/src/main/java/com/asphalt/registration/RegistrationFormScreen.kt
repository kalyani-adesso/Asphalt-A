...
fun RegistrationForm(
    ...
    Column(
        ...
        ComposeUtils.HeaderWithInputField(
            "Full Name",
            value = state.fullName,
            onValueChanged = { viewModel.onEvent(SignUpUiEvent.FullNameChagned(it)) },
            placeholder = "Full Name",
            isError = state.fullNameError != null,
            keyboardOptions = KeyboardOptions.Default.copy(imeAction = ImeAction.Next),
            errorText = state.fullNameError?.message.orEmpty(),
            backColor = NeutralLightPaper,
            leadingIcon = {
                Icon(
                    painter = painterResource(
                        id = R.drawable.ic_full_name
                    ),
...
//            }
//        )
//        state.fullNameError?.message?.let {
//            Text(
...
//        }
        ...
        ComposeUtils.HeaderWithInputField(
            "Email Id",
            value = state.email,
            onValueChanged = { viewModel.onEvent(SignUpUiEvent.EmailChagned(it)) },
            ...
            errorText = state.emailError?.message.orEmpty(), backColor = NeutralLightPaper,
            leadingIcon = {
                Icon(
                    painter = painterResource(
                        id = R.drawable.ic_email_blue_icon
                    ),
                    contentDescription = "Email Icon",
                    tint = PrimaryDarkerLightB75,
                )
...
//        }
        ...
        ComposeUtils.HeaderWithInputField(
            ...
            onValueChanged = { viewModel.onEvent(SignUpUiEvent.PasswordChagned(it)) },
            ...
            errorText = state.passwordError?.message.orEmpty(),
            backColor = NeutralLightPaper,
            leadingIcon = {
                Icon(
                    painter = painterResource(
                        id = R.drawable.ic_password_icon_blue
                    ),
                    contentDescription = "Email Icon",
                    tint = PrimaryDarkerLightB75,
                )
...
//            }
//        )
//        state.passwordError?.message?.let {
//            Text(
...
//        }
        ...
        ComposeUtils.HeaderWithInputField(
            ...
            onValueChanged = { viewModel.onEvent(SignUpUiEvent.CofirmPasswordChagned(it)) },
            ...
            errorText = state.confirmPasswordError?.message.orEmpty(),
            backColor = NeutralLightPaper,
            leadingIcon = {
                Icon(
                    painter = painterResource(
...
//            }
//        )
//        state.confirmPasswordError?.message?.let {
//            Text(
//                text = it, modifier = Modifier.fillMaxWidth(),
//                color = Color.Red
//            )
