                    ...
                    Row(
                        ...
                        TextField(
                            ...
                            trailingIcon = {
                                ...
                                Icon(
                                    painter = painterResource(if (showPassword) R.drawable.ic_eye_slash else R.drawable.ic_eye),
                                    contentDescription = "Email icon",
                                    tint = Color.Unspecified,
                    ...
                    Row(
                        ...
                        TextField(
                            ...
                            trailingIcon = {
                                ...
                                Icon(
                                    painter = painterResource(if (showConfirmPassword) R.drawable.ic_eye_slash else R.drawable.ic_eye),
                                    contentDescription = "Email icon",
                                    tint = Color.Unspecified,
                                    modifier = Modifier.clickable {
